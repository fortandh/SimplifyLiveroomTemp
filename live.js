...
// eslint-disable-next-line prefer-destructuring
                        ...
                        for (var s = 0; s < i.length; s++) {
                            var l = [].concat(i[s]);
                            n && o[l[0]] || (e && (l[2] ? l[2] = "".concat(e, " and ").concat(l[2]) : l[2] = e), t.push(l))
                        }
                    }, t
            }
        }, 330: (i, t, e) => {
            var n = e(946);
            n && n.__esModule && (n = n.default), i.exports = "string" == typeof n ? n : n.toString()
        }
    }, n = {};
    ...
    function o(i) {
        ...
        return e[i](r, r.exports, o), r.exports
    }

    t = Object.getPrototypeOf ? i => Object.getPrototypeOf(i) : i => i.__proto__, o.t = function (e, n) {
        ...
        var a = {};
        i = i || [null, t({}), t([]), t(t)];
        for (var s = 2 & n && e; "object" == typeof s && !~i.indexOf(s); s = t(s)) Object.getOwnPropertyNames(s).forEach((i => a[i] = () => e[i]));
        return a.default = () => e, o.d(r, a), r
    }, o.d = (i, t) => {
        for (var e in t) o.o(t, e) && !o.o(i, e) && Object.defineProperty(i, e, {enumerable: !0, get: t[e]})
    }, o.o = (i, t) => Object.prototype.hasOwnProperty.call(i, t), o.r = i => {
    ...
    return (() => {
        "use strict";
        o.d(r, {component: () => n});
        const i = coreApis.componentApis.switchOptions, t = coreApis.componentApis.styledComponent,
            e = coreApis.utils.urls, n = (0, i.newSwitchComponentWrapper)({
                name: "simplifyOptions",
                dimAt: "checked",
                switchProps: {checkedIcon: "mdi-eye-off-outline", notCheckedIcon: "mdi-eye-outline"},
                switches: {
                    vip: {defaultValue: !0, displayName: "老爷图标"},
                    enterPrompt: {defaultValue: !0, displayName: "入场通知"},
                    fansMedal: {defaultValue: !0, displayName: "粉丝勋章"},
                    title: {defaultValue: !0, displayName: "活动头衔"},
                    guard: {defaultValue: !0, displayName: "舰长图标"},
                    systemMessage: {defaultValue: !0, displayName: "全区广播"},
                    welcomeMessage: {defaultValue: !0, displayName: "欢迎信息"},
                    giftMessage: {defaultValue: !0, displayName: "礼物弹幕"},
                    emoticons: {defaultValue: !0, displayName: "表情特效"},
                    guardPurchase: {defaultValue: !0, displayName: "上舰提示"},
                    giftPanel: {defaultValue: !0, displayName: "付费礼物"},
                    headerPanel: {defaultValue: !1, displayName: "标题栏活动"},
                    userEffect: {defaultValue: !0, displayName: "入场特效"},
                    kanban: {defaultValue: !0, displayName: "看板娘"},
                    eventsBanner: {defaultValue: !1, displayName: "活动横幅"},
                    rankList: {defaultValue: !1, displayName: "排行榜"},
                    popup: {defaultValue: !1, displayName: "抽奖提示"},
                    pk: {defaultValue: !1, displayName: "PK浮窗"},
                    topRank: {defaultValue: !1, displayName: "高能榜提示"},
                ...
                description: {"zh-CN": "隐藏直播间中各种不需要的内容."},
                tags: [componentsTags.live, componentsTags.style],
                urlInclude: e.liveUrls,
                commitHash: "cbd8124874bde2a965802ef9991953c7086c5d57",
                coreVersion: "2.6.3"
            })
    })(), r = r.component
})()));